...
def fill():
    ...
    teacher = Tutor(name='Llambias')
    teacher2 = Tutor(name='Hernandez')
    session.add(teacher)
    ...
    Studen = Estudiante(name = 'Isabel', age = 24, grade = 6, tutor = teacher2)
    Studen2 = Estudiante(name = 'Laura', age = 18, grade= 6, tutor= teacher)
    Studen3 = Estudiante(name ='Rosalba', age = 60, grade= 6, tutor = teacher)
    Studen4 = Estudiante(name = 'Rosa', age = 55, grade = 6, tutor = teacher2)
    Studen5 = Estudiante(name = 'Marcela', age = 38, grade = 6, tutor = teacher)
    print(Studen,Studen2,Studen3,Studen4,Studen5)
...
def fetch():
    ...
    # todos los objetos creado2s de la tabla estudiante.
...
def search_by_tutor(tutor):
    ...
    query = session.query(Estudiante).join(Estudiante.tutor).filter(Tutor.name== tutor).count()
    print('estudiantes con tutor llambias', query)
...
def modify(id, name):
    ...
    #query = session.query(Tutor).filter(Tutor.name==name).update({Estudiante.tutor_id})
...
def count_grade(grade):
    ...
    query = session.query(Estudiante).filter(Estudiante.grade).count()
    print(query)
